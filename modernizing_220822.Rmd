...
I will try to ensure that a CRAN macOS M1 binary of **rgrass** is available before we meet, a vignette in 0.3-2 was broken by the absence of **stars** on that platform when the CRAN check was done. 0.3-3 has been submitted with the vignette logic error fixed.
